    ...
    int       nCmdShow)
{
    ...
    return StuntpilotPlayer::createAndRun();
}

int StuntpilotPlayer::createAndRun(void)
{
    StuntpilotPlayer *host = StuntpilotPlayer::sharedInstance();
    int ret = host->run();
    StuntpilotPlayer::purgeSharedInstance();
    return ret;
}

StuntpilotPlayer *StuntpilotPlayer::s_sharedInstance = NULL;

StuntpilotPlayer *StuntpilotPlayer::sharedInstance(void)
{
    if (!s_sharedInstance)
    {
        s_sharedInstance = new StuntpilotPlayer();
    }
    return s_sharedInstance;
}

void StuntpilotPlayer::purgeSharedInstance(void)
{
    if (s_sharedInstance)
    {
...
StuntpilotPlayer::StuntpilotPlayer(void)
: m_app(NULL)
, m_hwnd(NULL)
, m_exit(TRUE)
...
int StuntpilotPlayer::run(void)
{
    ...
    do
    {
        ...
        SetWindowTextA(m_hwnd, "stuntpilot-player");
...
void StuntpilotPlayer::loadProjectConfig(void)
{
    vector<string> args;
...
void StuntpilotPlayer::createViewMenu(void)
{
...
void StuntpilotPlayer::updateMenu(void)
{
    HMENU menu = GetMenu(m_hwnd);
    HMENU viewMenu = GetSubMenu(menu, 1);
...
void StuntpilotPlayer::updateWindowTitle(void)
{
}

void StuntpilotPlayer::relaunch(void)
{
...
void StuntpilotPlayer::writeDebugLog(const char *log)
{
...
// menu callback
void StuntpilotPlayer::onFileOpenProject(void)
{
...
void StuntpilotPlayer::onFileCreateProjectShortcut(void)
{
    ...
    if (SUCCEEDED(hres))
    {
        ...
        psl->SetDescription(L"StuntpilotPlayer");
...
void StuntpilotPlayer::onFileProjectConfig(void)
{
...
void StuntpilotPlayer::onFileRelaunch(void)
{
    relaunch();
}

void StuntpilotPlayer::onFileExit(void)
{
    DestroyWindow(m_hwnd);
}

void StuntpilotPlayer::onViewChangeFrameSize(int viewMenuID)
{
...
void StuntpilotPlayer::onViewChangeOrientation(int viewMenuID)
{
    bool isLandscape = m_project.isLandscapeFrame();
...
void StuntpilotPlayer::onViewChangeZoom(int scaleMode)
{
    float scale = 1.0f;
...
void StuntpilotPlayer::onHelpAbout(void)
{
    DialogBox(GetModuleHandle(NULL), MAKEINTRESOURCE(IDD_ABOUTBOX), m_hwnd, AboutDialogCallback);
}

// windows callback
LRESULT StuntpilotPlayer::WindowProc(UINT message, WPARAM wParam, LPARAM lParam, BOOL* pProcessed)
{
    int wmId, wmEvent;
    StuntpilotPlayer *host = StuntpilotPlayer::sharedInstance();
...
INT_PTR CALLBACK StuntpilotPlayer::AboutDialogCallback(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
