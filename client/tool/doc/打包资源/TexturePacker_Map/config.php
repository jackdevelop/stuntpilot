...
define('TP_BIN', '"C:\Program Files (x86)\TexturePacker\bin\TexturePacker.exe"'); //TexturePacker.exe的文件目录 
define('TP_FLAGS', '--algorithm MaxRects --smart-update '
        ...
        . '--scale-mode smooth --size-constraints POT ');
...
define('CWEBP_BIN','"C:\Program Files (x86)\WebP Codec\libwebp-0.2.0-windows-x64\cwebp.exe"');  //webp的cweb.exe的文件目录 
